...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Volkswagen App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Volkswagen App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Volkswagen App Login', user : req.user }); 
}); 
